...
<!-- prompt login -->
<footer class="footer fixed bottom-0 flex flex-col justify-around bg-neutral p-10 text-neutral-content md:flex-row">
	<aside>
		...
		<p>ログインして、友達の写真や動画を見たりフォローするアカウントを見つけたりしよう。</p>
	</aside>
	<nav>
