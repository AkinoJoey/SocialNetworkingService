					...
					<ul class="space-y-2 font-medium">
						...
						<li>
							...
							<a href="/logout" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
								<svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22">
								...
								<span class="ms-3 flex-1 whitespace-nowrap invisible lg:visible">ログアウト</span>
							</a>
						</li>
						<li>
