...
<div class="w-full min-w-80 sm:w-[512px] mt-4 flex flex-col overflow-hidden rounded-lg p-6 shadow-md dark:bg-gray-900 dark:text-gray-100 relative hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <div class="flex flex-wrap justify-between mt-6">
        <div class="flex space-x-2 text-sm dark:text-gray-400">
            <a href="/login" class="flex items-center space-x-1.5 p-1 z-30 hover:bg-gray-300 rounded-full">
            ...
            <a href="/login" class="z-30 flex items-center space-x-1.5 p-1 hover:bg-blue-100 rounded-full" data-post-id="<?= $post->getId() ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of likes" class="good-icon h-4 w-4 dark:text-violet-400">
