                ...
                <a href="<?= $href ?>" data-notification-id="<?= $notification->getId() ?>" data-notification-isRead="<?= $notification->getIsRead() ?>" class="notification flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:cursor-pointer">
                    <div class="indicator">
                        ...
                        <div class="flex w-full items-center">
                            <div class="mr-2">
                                <img class="rounded-full w-16 h-16 object-cover" src="<?= $notification->getProfileImagePath() === null ? '/images/user_default_portrait.png' : '/uploads/' . substr($notification->getProfileImagePath(), 0, 2) . '/' .  $notification->getProfileImagePath() . $notification->getProfileImageExtension() ?>" alt="user avatar" />
                            </div>
                            <div class="w-3/4">
