...
<div class="container mx-auto p-4">
	<div class="rounded-lg p-6 shadow-md dark:bg-gray-900 dark:text-gray-100 sm:m-12 lg:mx-40">
		<div class="flex flex-col space-y-4 lg:flex-row lg:space-x-6 lg:space-y-0">
			<img
				src="https://source.unsplash.com/75x75/?portrait"
				alt=""
				class="h-24 w-24 flex-shrink-0 self-center rounded-full border dark:border-gray-700 dark:bg-gray-500 lg:justify-self-start"
			/>
			<div class="flex flex-col">
				<h4 class="text-center text-lg font-semibold lg:text-left">Leroy Jenkins</h4>
				<p class="dark:text-gray-400">
					Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper
					sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis
					ultricies et nibh.
				</p>
			</div>
		</div>
		<div class="align-center flex justify-center space-x-4 pt-4">
			...
			>
				<svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-current">
					<path
			...
			<a
				...
				class="rounded-md p-2 dark:text-gray-100 hover:dark:text-violet-400"
			>
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-current">
					<path
...
<div class="container mx-auto mb-14 flex flex-col items-center justify-center p-4">
	<div
		class="mt-4 flex max-w-lg flex-col space-y-6 overflow-hidden rounded-lg p-6 shadow-md dark:bg-gray-900 dark:text-gray-100"
	>
		<div class="flex space-x-4">
			<img
				alt=""
				src="https://source.unsplash.com/100x100/?portrait"
				class="h-12 w-12 rounded-full object-cover shadow dark:bg-gray-500"
			/>
		...
		<div>
			<img
				...
				alt=""
				class="mb-4 h-60 w-full object-cover dark:bg-gray-500 sm:h-96"
			/>
			...
			<div class="space-x-2">
				<button aria-label="Share this post" type="button" class="p-2 text-center">
					<svg
						...
						viewBox="0 0 512 512"
						class="h-4 w-4 fill-current dark:text-violet-400"
					>
						<path
