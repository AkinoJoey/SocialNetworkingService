...
<div class="flex justify-center items-center p-6 container mb-6">
    <section class="bg-gray-100 text-gray-900 w-full sm:w-4/5 md:w-3/5">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="/form/setup" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="taro-yamada" required>
                    </div>
                    <div class="w-full">
