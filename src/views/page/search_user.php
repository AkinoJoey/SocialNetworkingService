            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                <a href="/profile?username=<?= $user->getUsername() ?>" class="notification flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:cursor-pointer">
                    <div class="flex w-full items-center">
                        <div class="mr-2">
                            <img class="rounded-full w-16" src="<?= $user->getProfileImagePath() === null ? '/images/user_default_portrait.png' : '/uploads/' . substr($user->getProfileImagePath(), 0, 2) . '/' .  $user->getProfileImagePath() . $user->getProfileImageExtension() ?>" alt="user avatar" />
                        </div>
                        <div class="w-3/4">
