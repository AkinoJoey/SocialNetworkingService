            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                <div class="flex w-full items-center">
                    ...
                    <div class="w-1/4 flex h-full justify-center items-center">
                        <button data-post-id="<?= $post->getId() ?>" data-post-type="post" type="button" class="delete-scheduled-post mt-2 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 z-10">削除</button>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
