<div class="container mx-auto mb-14 flex flex-col items-center justify-center p-4">
    <div class="mt-4 flex w-full flex-col space-y-6 overflow-hidden rounded-lg p-4 shadow-md dark:bg-gray-900 dark:text-gray-100 sm:w-4/5 md:w-3/5 lg:w-1/2">
        ...
        <div class="flex flex-wrap justify-between">
            ...
            <div class="w-full border-t border-gray-200">
                <form action="/form/post" method="POST">
                    ...
                    <div class="flex items-center justify-between px-4 text-blue-400">
                        ...
                        <div class="mb-1">
                            <button type="button" class="rounded-full bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Default
                            </button>
                        </div>
                    </div>
            ...
            <!-- comments -->
            <article class="border-t border-gray-200 bg-white p-6 text-base dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <article class="border-t border-gray-200 bg-white p-6 text-base dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700">
                <footer class="mb-2 flex items-center justify-between">
                    ...
                    <button id="dropdownComment3Button" data-dropdown-toggle="dropdownComment3" class="dark:text-gray-40 inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600" type="button">
                        <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 3">
                            <path d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
                        </svg>
                        <span class="sr-only">Comment settings</span>
